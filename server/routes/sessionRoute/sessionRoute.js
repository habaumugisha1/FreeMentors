...
sessionRoute.get('/sessions', routeMiddleware.canViewAllMentors, sessionRequestHandler.userSessions);
sessionRoute.get('/mentor/sessions', routeMiddleware.canViewAllMentors, sessionRequestHandler.mentorSessions);
